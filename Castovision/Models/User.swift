...
struct User {
    ...
    init(id: String? = nil, name: String? = nil, emailAddress: String? = nil, profileImageUrl: URL? = nil, profileImageData: Data? = nil, accountCreatedDate: Date? = nil, storageGigabytesRemaining: Double? = nil, savedEmailAddresses: [String]? = nil, stripeCustomerId: String? = nil) {
        self.id = id
        self.name = name
