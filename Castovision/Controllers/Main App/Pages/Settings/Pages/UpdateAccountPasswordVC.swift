...
class UpdateAccountPasswordVC: UIViewController {
    ...
    let instructionLabel: UILabel = {
        let label = UILabel()
        label.text = "Update your account password and click the save button to update the changes"
    ...
    override func viewDidLoad() {
        ...
        self.configureNavigationBar(withTitle: "Update Account Password", withSearchBar: false)
